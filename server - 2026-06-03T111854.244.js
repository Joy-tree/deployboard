...
app.get('/api/screenshot', requireAuth, async (req, res) => {
  ...
  try {
    const APIFLASH_KEY = process.env.APIFLASH_ACCESS_KEY || '5ec3b6376bb84deab00221ee16b821f3';
    const apiflashUrl = 'https://api.apiflash.com/v1/urltoimage'
      ...
      + '&delay=5&fresh=true&no_ads=true&scroll_page=false'
      + '&response_type=image&_n=' + Date.now();

    console.log('[Screenshot] Requesting APIFlash for:', targetUrl);
