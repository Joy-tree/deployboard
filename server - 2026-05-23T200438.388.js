      ...
      <tr>
        <td align="center">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:720px;background:#ffffff;border:1px solid #e2e8f0;border-radius:18px;overflow:hidden;">
            <tr>
              <td style="padding:24px 28px;background:linear-gradient(120deg,#0b1324,#14532d);color:#ffffff;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    <td style="width:56px;vertical-align:middle;">
                      <img src="${logoUrl}" alt="JOYTREE" width="46" height="46" style="width:46px;height:46px;border-radius:10px;background:#fff;display:block;object-fit:cover;">
                    </td>
                    <td style="vertical-align:middle;">
                      <div style="font-size:12px;letter-spacing:.14em;opacity:.85;text-transform:uppercase;">Welcome to JOYTREE</div>
                      <div style="margin-top:6px;font-size:28px;font-weight:800;line-height:1.15;">Your deployment workspace is ready</div>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            ${heroImageUrl ? `<tr><td><img src="${heroImageUrl}" alt="JOYTREE Welcome Banner" style="display:block;width:100%;max-height:300px;object-fit:cover;"></td></tr>` : ''}

            <tr>
              <td style="padding:30px 30px 10px 30px;">
                <h1 style="margin:0;font-size:30px;line-height:1.2;color:#0f172a;letter-spacing:-.02em;">Welcome, ${firstName}.</h1>
                <p style="margin:14px 0 0 0;font-size:15px;line-height:1.8;color:#334155;">
                  Thank you for verifying your account. JOYTREE is now fully unlocked for you — from GitHub deployments and real-time logs to domains, billing, and production operations.
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:20px 30px 0 30px;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #e2e8f0;border-radius:14px;overflow:hidden;">
                  <tr><td style="padding:16px 18px;border-bottom:1px solid #e2e8f0;"><strong style="font-size:15px;">Deploy from GitHub</strong><br><span style="color:#475569;font-size:14px;line-height:1.65;">Import repositories, configure build commands, and ship with confidence.</span></td></tr>
                  <tr><td style="padding:16px 18px;border-bottom:1px solid #e2e8f0;"><strong style="font-size:15px;">Live logs & diagnostics</strong><br><span style="color:#475569;font-size:14px;line-height:1.65;">Track every stage of your rollout in real time, from clone to production.</span></td></tr>
                  <tr><td style="padding:16px 18px;border-bottom:1px solid #e2e8f0;"><strong style="font-size:15px;">Domains & environment management</strong><br><span style="color:#475569;font-size:14px;line-height:1.65;">Set up custom domains, DNS checks, and secure environment variables.</span></td></tr>
                  <tr><td style="padding:16px 18px;"><strong style="font-size:15px;">Billing & usage control</strong><br><span style="color:#475569;font-size:14px;line-height:1.65;">Manage plans, usage limits, and payment history from one professional dashboard.</span></td></tr>
                </table>
              </td>
            </tr>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0">
                  <tr>
                    <td style="padding-right:10px;padding-bottom:10px;">
                      <a href="${dashboardUrl}" style="display:inline-block;background:linear-gradient(135deg,#16a34a,#15803d);color:#ffffff;text-decoration:none;padding:12px 20px;border-radius:10px;font-weight:700;font-size:14px;">Visit Dashboard</a>
                    </td>
                    <td style="padding-right:10px;padding-bottom:10px;">
                      <a href="${deployUrl}" style="display:inline-block;background:#0f172a;color:#ffffff;text-decoration:none;padding:12px 20px;border-radius:10px;font-weight:700;font-size:14px;">Create First Deployment</a>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              <td style="padding:16px 30px 0 30px;">
                <p style="margin:0;font-size:13px;color:#64748b;line-height:1.8;">
                  Quick links:
                  <a href="${docsUrl}" style="color:#0ea5e9;text-decoration:none;">Documentation</a> ·
                  <a href="${supportUrl}" style="color:#0ea5e9;text-decoration:none;">Support</a>
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:22px 30px 30px 30px;">
                <p style="margin:0;font-size:12px;color:#94a3b8;line-height:1.7;">
                  This is an automated welcome message from JOYTREE. If you need help onboarding your first project, reply to this email and our team will assist you.
                </p>
              </td>
            </tr>
          </table>
