...
async function runAgentSession(sessionId, { repoSlug, githubToken, errorText, deploymentId, projectName, userPrompt, mode, preferredProvider, analysisContext, sourceType, uploadProjectId, userId, userKeys }) {
...
app.post('/api/ai/agent/start', requireAuth, async (req, res) => {
  ...
  runAgentSession(sessionId, { repoSlug, githubToken, errorText, deploymentId, projectName, userPrompt, mode, preferredProvider, analysisContext,
                               sourceType: isUpload ? 'upload' : 'github', uploadProjectId: uploadProjectId || uploadSubdomain || '', userId, userKeys }).catch(e => {
